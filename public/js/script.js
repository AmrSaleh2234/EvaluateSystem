...
document.getElementById("qid").innerHTML += " <section class='add_question' ><div class='row d-flex align-items-center'><div class='col-lg-4 question'><label>Q"+ ++i +"</label><br><input type='text' name='question[]' required></div><div class='col-lg-6 choices d-flex align-items-center'><div class='dropdown  w-100 '><button class='btn btn-secondary dropdown-toggle w-100' type='button'id='dropdownMenuButton1' data-bs-toggle='dropdown' aria-expanded='false'>Choices</button><ul class='dropdown-menu w-100  ' aria-labelledby='dropdownMenuButton1'><li><input type='text' placeholder='  Enter Choice 1' name='choose1[]' required></li><li><input type='text' placeholder='  Enter Choice 2' name='choose2[]' required></li><li><input type='text' placeholder='  Enter Choice 3 (optional)' name='choose3[]'></li><li><input type='text' placeholder='  Enter Choice 4 (optional)' name='choose4[]'> </li> <li><input type='text' placeholder='  Enter Choice 5 (optional)' name='choose5[]'></li></ul></div></div><div class='col-lg-2 align-items-center answer'><label>Answer</label><br> <select name='answer[]'> <option>choice 1</option> <option>choice 2</option><option>choice 3</option><option>choice 4</option><option>choice 5</option></select></div></div></section>";
